...
typedef ngx_int_t (*ngx_http_modsecurity_resolv_header_pt)(ngx_http_request_t *r, ngx_str_t name);
...
int ngx_http_modsecurity_process_intervention (ngx_http_modsecurity_ctx_t *ctx, ngx_http_request_t *r);
